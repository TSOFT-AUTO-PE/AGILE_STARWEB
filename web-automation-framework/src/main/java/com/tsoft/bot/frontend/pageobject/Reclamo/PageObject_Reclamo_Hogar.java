...
public class PageObject_Reclamo_Hogar {
    ...
    public static By RDN_AVMOVTOTAL = By.xpath("//*[@id=\"divGround\"]/label[2]");
    public static By RDN_AVMOVINTERNET = By.xpath("//*[@id=\"divGround\"]/label[3]");
    public static By RDN_AVSOLOLINEA = By.xpath("//*[@id=\"divGround\"]/label[4]");
    public static By RDN_AVDUO = By.xpath("//*[@id=\"divGround\"]/label[5]");

    public static By RDN_COBRO = By.xpath("//*[@id=\"divGround\"]/label[2]");
    public static By RDN_TARIFA = By.xpath("//*[@id=\"divGround\"]/label[1]");
    public static By RDN_VOUCHER = By.xpath("//*[@id=\"divGround\"]/label[2]");
    public static By RDN_CONTRATO = By.xpath("//*[@id=\"divGround\"]/label[3]");


    public static By RDN_RECIBOSPAGO = By.xpath("//*[@id=\"divGround\"]/label[3]");
    public static By RDN_CORREO = By.xpath("//*[@id=\"divGround\"]/label[1]");
    public static By RDN_DOMICILIO = By.xpath("//*[@id=\"divGround\"]/label[2]");
    public static By RDN_DETLLAMADAS = By.xpath("//*[@id=\"divGround\"]/label[3]");

    public static By RDN_OFRECIMIENTO = By.xpath("//*[@id=\"divGround\"]/label[4]");
    public static By RDN_PROMOCION = By.xpath("//*[@id=\"divGround\"]/label[1]");
   ...
   // public static By BTN_CONTINUAR_MONTO = By.xpath("/html/body/div[1]/div/div[1]/div/div/div/div/div/div/form/div/div/div[2]/div/div[2]/input");
    public static By RDN_CONCEPTO = By.xpath("//*[@id=\"divGround\"]/label[3]");

    public static By RDN_TRASLADO = By.xpath("//*[@id=\"divGround\"]/label[4]");
    public static By RDN_FRACCIONADO = By.xpath("//*[@id=\"divGround\"]/label[1]");
    public static By RDN_CONTADO = By.xpath("//*[@id=\"divGround\"]/label[2]");
    public static By RDN_RECORRIDO = By.xpath("//*[@id=\"divGround\"]/label[5]");
    public static By RDN_NUMERO = By.xpath("//*[@id=\"divGround\"]/label[6]");
    public static By RDN_TITULARIDAD = By.xpath("//*[@id=\"divGround\"]/label[7]");
    public static By RDN_PAGINAS = By.xpath("//*[@id=\"divGround\"]/label[8]");
    public static By RDN_SITIO = By.xpath("//*[@id=\"divGround\"]/label[9]");

    public static By RDN_SUSPENSION = By.xpath("//*[@id=\"divGround\"]/label[2]");
    public static By RDN_RECONEXION = By.xpath("//*[@id=\"divGround\"]/label[1]");
    public static By RDN_BAJA = By.xpath("//*[@id=\"divGround\"]/label[2]");

    public static By RDN_EQUIPO = By.xpath("//*[@id=\"divGround\"]/label[3]");
    public static By RDN_COBDIST = By.xpath("//*[@id=\"divGround\"]/label[1]");

    public static By RDN_EQDEVUELTO = By.xpath("//*[@id=\"divGround\"]/label[2]");
    public static By TXT_COMODEVOLVIO = By.xpath("//*[@id=\"H_COMO_DEVOLVIO\"]");

    public static By RDN_NOSOLICEQ = By.xpath("//*[@id=\"divGround\"]/label[3]");
    public static By RDN_NOLLEGEQ = By.xpath("//*[@id=\"divGround\"]/label[4]");
    public static By RDN_NORECMONTO = By.xpath("//*[@id=\"divGround\"]/label[5]");

    public static By RDN_MIGRACION = By.xpath("//*[@id=\"divGround\"]/label[4]");
    public static By RDN_NOSOLICMIG = By.xpath("//*[@id=\"divGround\"]/label");


    public static By RDN_ALTA = By.xpath("//*[@id=\"divGround\"]/label[5]");
    public static By RDN_PAQUETE = By.xpath("//*[@id=\"divGround\"]/label[1]");
    public static By RDN_IMPORTE = By.xpath("//*[@id=\"divGround\"]/label[2]");
    public static By RDN_SERVICIO = By.xpath("//*[@id=\"divGround\"]/label[3]");
    public static By RDN_PQCOMPLETO = By.xpath("//*[@id=\"divGround\"]/label[1]");
    public static By RDN_SOLOLINEA = By.xpath("//*[@id=\"divGround\"]/label[2]");
    public static By RDN_MOVISTARTV = By.xpath("//*[@id=\"divGround\"]/label[3]");
    public static By RDN_MOVISTARINTER = By.xpath("//*[@id=\"divGround\"]/label[4]");

    public static By RDN_FACTURACION = By.xpath("//*[@id=\"divGround\"]/label[6]");
    public static By RDN_CELULAR = By.xpath("//*[@id=\"divGround\"]/label[1]");
    public static By RDN_LD = By.xpath("//*[@id=\"divGround\"]/label[2]");
    public static By RDN_OTLLAMADAS = By.xpath("//*[@id=\"divGround\"]/label[3]");
    public static By RDN_COSTOBLOQUEO = By.xpath("//*[@id=\"divGround\"]/label[4]");
    public static By RDN_COSTOLLAMADA = By.xpath("//*[@id=\"divGround\"]/label[5]");
    ...
    public static By TXT_VAL_RECLAMO = By.xpath("/html/body/div[1]/div/div[1]/div/div/div/div/div/div/form/div[1]/div/div/h1");
